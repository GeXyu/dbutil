...
import cn.zzcode.handler.ColumnDefintionHandler;
 ...
 */
public class ColumnDefinitionTask extends DefinitionTask implements Runnable {
     ...
     */
    public ColumnDefinitionTask(TableDefinition tableDefinition) {
    ...
    public void run() {
        ...
        ColumnDefintionHandler columnDefintionHandler = new ColumnDefintionHandler(this.tableDefinition);
        try {
            columnDefintionHandler.handler(CoreStartup.getDataBaseDefinition(),
