...
import cn.zzcode.handler.TableDefinitionHandler;
 ...
 */
public class TableDefinitionTask extends DefinitionTask implements Runnable {
    ...
    public void run() {
        try {
            new TableDefinitionHandler().handler(CoreStartup.getDataBaseDefinition(),
